...
function AppointmentForm({
  ...
  return (
    <section className="flex h-full flex-col rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      ...
      {!selectedPatient ? (
        <p className="flex-1 rounded-md border border-slate-200 bg-slate-50 p-4 text-base text-slate-500">
          환자를 선택하면 예약을 등록할 수 있습니다.
        </p>
      ) : (
        <form onSubmit={onCreateAppointment} className="flex flex-1 flex-col gap-3">
